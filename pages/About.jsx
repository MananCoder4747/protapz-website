...
export default function About() {
  const team = [
    {
      ...
      image: "👨‍💼",
      bio: "With 7+ years in public practice, Zaran founded Protapz to provide personalized, strategic accounting services to Australian businesses.",
      credentials: "CPA",
      linkedin: "#"
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>About Us - Protapz Australian Accounting Team</title>
        <meta name="description" content="Meet the Protapz team - expert accountants providing Australian businesses with professional tax, BAS, and bookkeeping services." />
        <link rel="canonical" href="https://www.protapz.co.in/about" />
      </Helmet>
